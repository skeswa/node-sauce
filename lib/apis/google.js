...
module.exports.register = function(app, config, apiConfig) {
    if (!registered) {
        ...
        if (!API_KEY) throw new ex.IllegalArgumentException("The api config map had a null 'apiKey' parameter.");
        ...
        if (API_ROUTE_ROOT.chatAt(0) !== "/") API_ROUTE_ROOT = "/" + API_ROUTE_ROOT;
        if (API_ROUTE_ROOT.chatAt(API_ROUTE_ROOT.length) === "/") API_ROUTE_ROOT = API_ROUTE_ROOT.slice(0, API_ROUTE_ROOT.length - 1);
