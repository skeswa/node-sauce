...
var Client = function(baseUrl, accessToken, config) {
	var endpoint = function(method, url) {
		...
		var chainObj = {
			...
			call: function() {
				...
				headers["Authorization"] = (config.authorizationHeaderPrefix ? config.authorizationHeaderPrefix : "OAuth") + " " + accessToken; // TODO, this is OAuth 2.0 specific
				var options = {};
				if (payload) {
