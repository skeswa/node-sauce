 ...
 *              - excludeAuthorizationHeader - OPTIONAL - Boolean - if true, the authorization header of each api request is omitted
 *              - authorizationHeaderPrefix - OPTIONAL - String - the string that prepends the auth token in the authorization header (obviously ignored if excludeAuthorizationHeader is true)
