...
//set up secure user data routes
var userData = function(schemaName, storageConfigs){
	if (!app) throw new ex.ExpressApplicationNotYetBoundException();
	var dataModule = require('./data/userdata.js');
	dataModule.setupUserDataRoutes(app, schemaName, storageConfigs);
	return exp;
};
