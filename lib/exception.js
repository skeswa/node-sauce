...
var UnsupportedOperationException = function(_message) {
    Error.captureStackTrace(this, this);
    this.message = _message;
}
util.inherits(UnsupportedOperationException, Error);
UnsupportedOperationException.prototype.name = "UnsupportedOperationException";
module.exports.UnsupportedOperationException = UnsupportedOperationException;